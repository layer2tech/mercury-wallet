...
import { callUpdateConfig, setNotification } from '../../features/WalletDataSlice'
import './tutorial.css';
  ...
  return (
    <div className="tutorial-page">
      ...
      <div className="tutorial-content">
        ...
        <p>
        Lorem ipsum dolor sit short 3 - 5 sentence explainer on how the swapping works and what the user 
should expect.
        </p>
        <div className="tutorial-btns">
          <button type="button">Skip</button>
          <button type="button">Next</button>
          <button type="button" className="hide-tutorial" onClick={hideTutorial}>I understand</button>
        </div>
      </div>
    </div>
  );
