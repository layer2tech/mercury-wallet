...
const PanelConnectivity = (props) => {
  ...
  useEffect(() => {
    ...
    let isMounted = true
    let interval = setIntervalIfOnline(updateSpeedInfo, torInfo.online, 5000, isMounted)
  ...
  useEffect(() => {
    ...
    let interval = setIntervalIfOnline(getBlockHeight, torInfo.online, 5000, isMounted)
