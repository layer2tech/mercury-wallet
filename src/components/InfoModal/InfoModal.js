...
import { callAddDescription, callGetConfig, callGetNetwork, callGetStateCoin, setShowDetailsSeen, setWarning, setWarningSeen } from '../../features/WalletDataSlice';
...
const InfoModal = () => {
    ...
    const onClickTXID = txId => {
        ...
        dispatch(setWarning({ title: "Privacy Warning",
    ...
    <Modal
        ...
        ) || (showDetails?.coin?.swap_status !== null) ? "modal coin-details-modal lower" : "modal coin-details-modal"}
        >
        <Modal.Body >
          <div>
            <div className="item">
            ...
            {showDetails?.coin?.status && filterBy === "default" &&
              showDetails.coin.status !== STATECOIN_STATUS.AVAILABLE && (
                <div className="item swap-status-container">
                  ...
                  {showDetails.coin.swap_status !== null ? (<SwapStatus swapStatus={SWAP_STATUS_INFO[showDetails.coin.ui_swap_status]} />) : (null)}
                </div>
              )}
              ...
              <div>
                <div className="item qr-container">
                  <div className="block qrcode">
                    ...
                    <QRCodeGenerator address={getAddress(showDetails.coin.shared_key_id)} amount={fromSatoshi(showDetails.coin.value)} />
                  </div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <div className='item'>
                    ...
                    <div className="block">
                      ...
                      {
                        showDetails.coin.sc_address != undefined && (<span>
                          {showDetails.coin.sc_address}
                        </span>)
                      }
                    </div>
                  </div>
                  ...
                  <div className="item">
                    ...
                    <div className="block">
                      <span>UTXO ID</span>
                      <span><button className='coinURLButton' onClick={() => onClickTXID(showDetails.coin.funding_txid)}><div className='coinURLText'>{showDetails.coin.funding_txid}:{showDetails.coin.funding_vout}</div></button></span>
                    </div>
                  </div>
                    ...
                    <div className="expiry-time-wrap">
                      ...
                      <div className="block">
                        ...
                        <span className="expiry-time-left">
                          {displayExpiryTime(
                            showDetails.coin.expiry_data, true
                          )}
                      ...
                      <div className="sub">
                        <ProgressBar>
                          <ProgressBar
                            striped
                            variant={
                              showDetails.coin.expiry_data.days <
                                DAYS_WARNING
                                ? "danger"
                                : "success"
                            }
                            now={
                              (showDetails.coin.expiry_data.days * 100) / 90
                            }
                            key={1}
                          />
                        </ProgressBar>
                  ...
                  <div className="item">
                    <img src={showDetails.coin.privacy_data.icon1} alt="icon" className="privacy" />
            ...
            {showDetails?.coin?.status && (showDetails.coin.status === STATECOIN_STATUS.WITHDRAWN || showDetails.coin.status === STATECOIN_STATUS.WITHDRAWING) ?
              (
                <div>
                      ...
                      <div className="txhex-container">
                        ...
                        <CopiedButton handleCopy={(e) => copyToClipboard(e)}>
                          <div className="copy-hex-wrap coin-modal-hex">
                            <img type="button" src={icon2} alt="icon" />
                            <span>
                              {showDetails.coin.withdraw_txid}
                            </span>
                          </div>
                        </CopiedButton>
                      </div>
