...
import './torInfo.css'
import TorNode from './TorNode'
import {HttpClient} from '../../../wallet/http_client'
...
const TorInfo = (props) => {
    ...
    useEffect(() => {
        async function getTorData(){
            // get tornode data here...
            try{

                setTorData(tor_circuits);
                setTorLoaded(true);
            }catch(err){
                console.log(err);
            }
    ...
    return (
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                ...
                <div>
                    <ul>
                        <TorNode className='passed' name='Mercury Wallet'></TorNode>
                        <TorNode className='passed' name='Czech Republic'></TorNode>
                        <TorNode className='passed' name='UK'></TorNode>
                        <TorNode className='passed' name='Relay'></TorNode>
                        <TorNode className='passed' name='Relay'></TorNode>
                        <TorNode className='passed' name='Relay'></TorNode>
                        <TorNode className='current' name='Onion Address'></TorNode>
                    </ul>
                    <button class='Body-button'>New circuit</button>
                </div>) :  
                (<div>
                    <p>Couldn't connect to tor</p>
                </div> )
                }
            </div>
        </div>
