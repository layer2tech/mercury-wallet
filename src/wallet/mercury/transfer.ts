...
//      e. Verify o2*S2 = P
const validate_transfer_msg3 = (transfer_msg3: any) => {
  if (transfer_msg3.shared_key_id === undefined) throw Error('transfer_msg3.shared_key_id is undefined');
  if (transfer_msg3.t1 === undefined) throw Error('transfer_msg3.t1 is undefined');
  if (transfer_msg3.statechain_sig === undefined) throw Error('transfer_msg3.statechain_sig is undefined');
  if (transfer_msg3.statechain_id === undefined) throw Error('transfer_msg3.statechain_id is undefined');
  if (transfer_msg3.tx_backup_psm === undefined) throw Error('transfer_msg3.tx_backup_psm is undefined');
  if (transfer_msg3.rec_se_addr === undefined) throw Error('transsfer_msg3.rec_se_addr is undefined');
}
...
export const transferSender = async (
  ...
  if (sc_statecoin === undefined || sc_statecoin === null) throw Error("sc_statecoin was null or undefined");
  ...
  if (is_batch) {
    if (statecoin.swap_id) {
      ...
      if (statecoin.swap_id.id === undefined || statecoin.swap_id.id === null) throw Error('statecoin.swap_id.id was null or undefined');
    }
  }

  //  if any of the variables inside transfer_msg1 is null throw an error
  if (statecoin.shared_key_id === undefined || statecoin.shared_key_id === null) throw Error('statecoin.shared_key_id was null or undefined');
  if (statechain_sig === undefined || statechain_sig === null) throw Error('statechain_sig created for transfer was null or undefined');
  ...
  if (receiver_addr === undefined || receiver_addr === null) throw Error('receiver_addr was null or undefined');
  if (network === undefined || network === null) throw Error('network was null or undefined');
  ...
  if (new_tx_backup.outs[0].script === undefined) throw Error('new_tx_backup.outs[0].script undefined');


  if (statecoin_data.locktime === undefined) throw Error('statecoin_data.locktime undefined');
  if (fee_info.interval === undefined) throw Error('fee_info.interval undefined');

  new_tx_backup.locktime = statecoin_data.locktime - fee_info.interval;
  if (new_tx_backup.locktime === undefined) throw Error('new_tx_backup.locktime undefined');

  let pk = statecoin.getSharedPubKey();
  if (pk === undefined) throw Error('pk undefined');

  let signatureHash = getSigHash(new_tx_backup, 0, pk, statecoin.value, network);
  if (signatureHash === undefined) throw Error('signatureHash undefined');
  ...
  if (signature === undefined) throw Error('signature returned undefined');
  if (signature[0] === undefined) throw Error('signature[0] is undefined');
  if (signature[1] === undefined) throw Error('signature[0] is undefined');
  ...
  if (prepare_sign_msg.tx_hex === undefined) throw Error('prepare_sign_msg.tx_hex is undefined');

  // validate statecoin properties exist
  if (statecoin.shared_key === undefined) throw Error('shared_key is undefined');
  if (statecoin.shared_key.private === undefined) throw Error('shared_key.private is undefined');
  if (statecoin.shared_key.private.x2 === undefined) throw Error('shared_key.private.x2 is undefnied');
  ...
  if (o1 === undefined) throw Error('o1 is undefined in transferSender');
  if (x1_dec === undefined) throw Error('x1_dec is undefined in transferSender');

  let o1_bn = new BN(o1, 16);
  let x1_bn = new BN(x1_dec, 16);
  if (o1_bn === undefined) throw Error('o1_bn is undefined in transferSender');
  if (x1_bn === undefined) throw Error('x1_bn is undefined in transferSender');

  // t1 = o1x1
  let t1 = o1_bn.mul(x1_bn).umod(n);
  if (t1 === undefined) throw Error('t1 was undefined in transferSender')

  let t1_enc = {
    secret_bytes: Array.from(encryptECIES(receiver_addr, t1.toString("hex")))
  }
  if (t1_enc.secret_bytes === undefined) throw Error('t1_enc.secret_bytes is undefined');
  ...
  validate_transfer_msg3(transfer_msg3);
