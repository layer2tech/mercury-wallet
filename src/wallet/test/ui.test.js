...
async function getWallet() {
    let wallet = await Wallet.buildMock(bitcoin.networks.bitcoin,http_mock,wasm_mock, mnemonic, walletName);
...
describe('Wallet Load - Large Swapped IDs Storage', function () {
    ...
    beforeEach(async () => {
        ...
        swapArr = SWAPPED_IDS['f248181cdd052d8cb8d6dc1fd4f9af8a000fb834442b9c97b45f593f9f62c9da:1']
        for( let i = 0; i < 5 ; i++ ){
            swapArr = swapArr.concat(swapArr)
            // Make large swap array for single coin
        }
        let swapIds = SWAPPED_IDS;
        swapIds['f248181cdd052d8cb8d6dc1fd4f9af8a000fb834442b9c97b45f593f9f62c9da:1'] = swapArr
    ...
    test('Open Wallet - large file', async function(){
        ...
        fireEvent.change(screen.getByPlaceholderText(/Password/i), { target: { value: MOCK_WALLET_PASSWORD } });
