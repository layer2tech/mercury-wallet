// important: settings.json must have testing_mode set to true manually for tests to run in a testing environment (using mock network object)
...
describe("createBackupTxCPFP", function () {
  ...
  test("createdBackupTxCPFP valid", async () => {
...
describe("processTXBroadcastResponse", () => {
  let statecoin;
  let wallet;
  beforeAll(async () => {
...
describe("processTXBroadcastError", () => {
  let statecoin;
  let wallet;
  beforeAll(async () => {
    try {
...
describe("backupTxCheckRequired", () => {
  let statecoin;
