...
export const setSwapDetails = (statecoin, phase) => {
  ...
  statecoin.swap_transfer_finalized_data =
    new_data.swap_transfer_finalized_data;
...
const get_statecoin_out_expected = (statecoin_out, smt_proof = null) => {
  ...
  statecoin_out_expected.shared_key_id =
    mock_http_client.TRANSFER_FINALIZE_DATA.new_shared_key_id;
  statecoin_out_expected.statechain_id =
    mock_http_client.TRANSFER_FINALIZE_DATA.statechain_id;
  statecoin_out_expected.funding_txid =
    mock_http_client.RECOVERY_STATECHAIN_DATA.utxo.txid;
  statecoin_out_expected.is_new = true;
  statecoin_out_expected.proof_key =
    mock_http_client.RECOVERY_STATECHAIN_DATA.chain[
      mock_http_client.RECOVERY_STATECHAIN_DATA.chain.length - 1
    ].data;
  statecoin_out_expected.sc_address =
    "sc1qvl2s57h77wr93wjvtgdtkzetv2ypjw67k8qysz82zltvjgds29vq3ahfez";
  ...
  it("should give a new statecoin", async () => {
    ...
    electrum_mock.getTransaction = jest.fn((param1) => {
      return new Promise(function (resolve) {
        resolve({
          txid: "c33c88b149ec86eb99f1b5d6177ccd198833b07735bfd3049d2dd90c9c0328fc",
          hash: "47cb606ed7f772a6fbc0e41f3a084e4e54f2ceafffef51c2349ce663ff3095ed",
          version: 1,
          size: 208,
          vsize: 181,
          weight: 724,
          ...
          hex: "",
          blockhash:
