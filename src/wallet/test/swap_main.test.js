...
describe('Do Swap Poll', function () {
  ...
  test('doSwapPoll successful', async function () {
    ...
    // let new_statecoin = await swap_lib.doSwapPoll(http_mock, electrum_mock, wasm_mock, bitcoin.networks.bitcoin, statecoin, proof_key_der, swap_size, proof_key_der, 3, wallet)
