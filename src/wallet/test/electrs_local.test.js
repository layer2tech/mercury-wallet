 ...
 */
console.log("electrs_local.test.js");
...
const testnet_command =
  "bitcoin-core.cli -conf=/home/ldeacon/bitcoin-testnet-conf/bitcoin.conf -rpcport=18334 -rpcuser=username -rpcpassword=password";
const regtest_command =
  "bitcoin-core.cli -conf=/home/ldeacon/bitcoin-regtest/bitcoin.conf -rpcport=18333 -rpcuser=username -rpcpassword=password";
const regtest_umbrel_2 =
  "/media/ldeacon/Elements/umbrel_regtest/bin/bitcoin-cli";
const regtest_umbrel =
  "bitcoin-core.cli -conf=/media/ldeacon/Elements/umbrel_regtest//bitcoin.conf -rpcport=18443 -rpcuser=umbrel -rpcpassword=WiEh1Ufmfl3JlTSeAnwO3CQi0B0dDz1lmqvgigwPiHc=";
...
describe.skip("ElectrsLocalClient", function () {
  ...
  test("broadcastTransaction", async function () {
    ...
    await expect(client.broadcastTransaction(tx_hex)).rejects.toThrow(
