...
import { swapPhase1, SWAP_STATUS, POLL_UTXO, SwapToken, make_swap_commitment, checkEligibleForSwap, asyncSemaphoreRun } from "../swap/swap";
...
describe('swapPhase1 test 1 - incorrect status', () => {
    ...
    it('throws error on null status', async () => {
        const input = () => {
            return swapPhase1(http_mock, wasm_mock, statecoin, proof_key_der, proof_key_der);
        }
...
describe('swapPhase1 test 2 - incorrect swap_status', () => {
    ...
    it('throws error on null swap_status', async () => {
        ...
        const output = "Coin is not in this phase of the swap protocol. In phase: null";
