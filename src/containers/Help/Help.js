            ...
            <Tabs defaultActiveKey="About">
                ...
                <Tab eventKey="Privacy Policy" title="Privacy Policy">
                    <div className="content">
                        ...
                        <p>Please contact the Mercury Wallet Legal team (legal@mercurywallet.com) if you have any questions about its privacy practices that are not addressed in this Privacy Statement.</p>
                        <p>Please note: Layer Two Limited provides written user support only. Mercury does not offer phone support and will never call, e-mail or get in touch in any form with users to offer any wallet recovery services. Users are advised to be safe and guard their wallet information and funds. If you see any signs of abuse in this regard, please contact our Legal Team (legal@mercurywallet.com)</p>
                        <h6>Definitions</h6>
