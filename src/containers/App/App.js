    ...
    <div className={`App ${dark_mode === "1" ? "dark-mode" : ""}`}>
      ...
      <Router>
        <Header
          ...
          setWalletLoaded={setWalletLoaded}
          online={online}
        />
        <Switch>
          ...
          <Route
            ...
            exact
            component={() => (
              <CreateWalletWizardPage setWalletLoaded={setWalletLoaded} />
            )}
          />
          <Route
            path="/load_wallet"
            exact
            component={() => (
              <LoadWalletPage setWalletLoaded={setWalletLoaded} />
            )}
          />
          <Route
            path="/restore_wallet"
            exact
            component={() => (
              <RestoreWalletPage setWalletLoaded={setWalletLoaded} />
            )}
          />
          <Route
            path="/home"
          ...
          <Route
            path="/settings"
            exact
            component={() => <SettingsPage setWalletLoaded={setWalletLoaded} />}
          />
          <Route
            path="/help"
            exact
            component={() => <HelpPage walletLoaded={walletLoaded} />}
          />
