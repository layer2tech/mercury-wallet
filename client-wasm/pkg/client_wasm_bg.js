...
export class BSTRequestorData {
  ...
  static make_blind_spend_token(bst_requestor_data_str, signature_str) {
    ...
    var len1 = WASM_VECTOR_LEN;
    var ret = wasm.bstrequestordata_make_blind_spend_token(
      ptr0,
      len0,
      ptr1,
      len1
  ...
  static requester_calc_s(s_prime, u, v) {
    ...
    var len2 = WASM_VECTOR_LEN;
    var ret = wasm.bstrequestordata_requester_calc_s(
      ptr0,
      len0,
      ptr1,
      len1,
...
export class Sign {
  ...
  static second_message(
    ...
    var ptr4 = passStringToWasm0(
      message,
      wasm.__wbindgen_malloc,
      wasm.__wbindgen_realloc
    );
    var len4 = WASM_VECTOR_LEN;
    var ret = wasm.sign_second_message(
      ptr0,
      len0,
      ptr1,
      len1,
