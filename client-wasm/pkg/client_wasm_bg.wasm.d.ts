...
export function verify_statechain_smt(a: number, b: number, c: number, d: number, e: number, f: number, g: number): void;
export function solve_pow_challenge(a: number, b: number, c: number): void;
export function __wbg_keygen_free(a: number): void;
export function keygen_first_message(a: number, b: number, c: number): void;
export function keygen_second_message(a: number, b: number, c: number, d: number, e: number): void;
export function keygen_set_master_key(a: number, b: number, c: number, d: number, e: number, f: number, g: number): void;
export function __wbg_sign_free(a: number): void;
export function sign_first_message(a: number): void;
export function sign_second_message(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number): void;
export function __wbg_swap_free(a: number): void;
export function swap_requester_calc_eprime(a: number, b: number, c: number, d: number, e: number): void;
export function __wbg_bstsenderdata_free(a: number): void;
export function bstsenderdata_setup(a: number): void;
export function __wbg_bstrequestordata_free(a: number): void;
export function bstrequestordata_setup(a: number, b: number, c: number, d: number, e: number): void;
export function bstrequestordata_make_blind_spend_token(a: number, b: number, c: number, d: number, e: number): void;
export function bstrequestordata_requester_calc_s(a: number, b: number, c: number, d: number, e: number, f: number, g: number): void;
export function __wbg_commitment_free(a: number): void;
export function commitment_make_commitment(a: number, b: number, c: number): void;
export function test_wasm(): void;
export function curv_ge_to_bitcoin_public_key(a: number, b: number, c: number): void;
export function convert_bigint_to_client_curv_version(a: number, b: number, c: number, d: number, e: number): void;
